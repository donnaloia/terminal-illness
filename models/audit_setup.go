...
type AuditSetupModel struct {
	inputs   []textinput.Model
	selected int
	focused  bool
}

func InitialAuditSetupModel(selected int) AuditSetupModel {
	m := AuditSetupModel{
	...
	for i := range m.inputs {
		...
		switch i {
		case 0:
			t.Placeholder = "https://api.thecatapi.com/v1/"
...
func (m AuditSetupModel) View() string {
...
func (m AuditSetupModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	switch msg := msg.(type) {
	case tea.KeyMsg:
		switch msg.String() {
		case "ctrl+c", "esc":
...
func (m *AuditSetupModel) updateInputs(msg tea.Msg) tea.Cmd {
	var cmds []tea.Cmd
...
func (m AuditSetupModel) Init() tea.Cmd {
	return nil
}

func (m *AuditSetupModel) Focus() {
	m.focused = true
	m.selected = 0
	if len(m.inputs) > 0 {
		m.inputs[0].Focus()
